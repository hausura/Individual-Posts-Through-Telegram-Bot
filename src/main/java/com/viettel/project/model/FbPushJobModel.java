...
public class FbPushJobModel {
    ...
    public FbPushJobModel(String target_id) {
        this.target_id = target_id;
    }

    public FbPushJobModel(Integer id, String target_id, String profile_type, String job_action, String job_output, String time_start, String time_stop, String token_action, String object_depend, String priority) {
        this.id = id;
        this.target_id = target_id;
